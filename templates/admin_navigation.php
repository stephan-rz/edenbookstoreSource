...
<h1>Admin Dashboard</h1>
    ...
    <div class="button-container">
        ...
        <a href="admin_product_list.php" class="<?php echo ($title == "Book List" ? "active" : "")?> admin-btn btn">Product List</a>
        <a href="admin_add_product.php" class="<?php echo ($title == "Add Book" ? "active" : "")?> admin-btn btn">Add Product</a>
        <a href="admin_category.php" class="<?php echo ($title == "Add Book Category" ? "active" : "")?> admin-btn btn">Product Categories</a>
